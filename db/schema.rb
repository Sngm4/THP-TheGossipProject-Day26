...
ActiveRecord::Schema.define(version: 2022_05_11_133557) do
  ...
  create_table "create_private_messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["recipient_id"], name: "index_create_private_messages_on_recipient_id"
    t.index ["sender_id"], name: "index_create_private_messages_on_sender_id"
  end
